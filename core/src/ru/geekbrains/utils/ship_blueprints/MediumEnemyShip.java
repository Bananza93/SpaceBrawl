...
public class MediumEnemyShip {
    ...
    private static final float SHIP_SPEED = 0.003f;
    private static final int SHIP_INIT_HEALTH = 6;
    private static final float SHOOT_DELAY = 1.0f;
    private static final float BULLET_HEIGHT = 0.02f;
    private static final Vector2 BULLET_SPEED = new Vector2(0, -0.35f);
